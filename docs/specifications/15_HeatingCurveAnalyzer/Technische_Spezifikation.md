...
SNAPSHOT_WARN_MS = 15000

SNAPSHOT_ERROR_MS = 60000
...
Die Laufzeitüberwachung dient ausschließlich der technischen Diagnose.
Sie beeinflusst weder die Messwerterfassung noch die Analyse,
die Gültigkeitsbewertung oder die Erzeugung des `AI.AnalysisPayload`.
